<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="incorrectCredentialsPage.aspx.cs" Inherits="AndroApp.Web_Forms.incorrectCredentialsPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="content3" ContentPlaceHolderID="navContentPlaceHolder" runat="server">
        <asp:Button ID="signupNav" runat="server" Text="Sign Up" class="topRight topMenu lightText" CausesValidation="false" OnClick="signupNav_Click"/>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageContent" runat="server">
        <div class="wrapper lightBackground">
            <div class="incorrectCredentialsContainer darkBackground">
                ...
                <asp:TextBox ID="emailTxt" runat="server" TextMode="Email" placeholder="Enter Email" name="uname" class="loginInput"></asp:TextBox><br />

                <asp:RequiredFieldValidator ID="passwordValidator" ControlToValidate="passwordTxt"  runat="server" ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator><label for="psw" class="boldText lightText negativeMargin">Password</label><br />
                <asp:TextBox ID="passwordTxt" runat="server" TextMode="Password" placeholder="Enter Password" name="psw" class="loginInput"></asp:TextBox><br />
