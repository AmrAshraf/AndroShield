...
<asp:Content ID="content" ContentPlaceHolderID="pageContent" runat="server">
        ...
        <div class="wrapper lightBackground">
            <div class="loginContainer">
                ...
                <asp:LinkButton ID="fbButton" CausesValidation="false" class="homeButtons facebookLogin lightText boldText" runat="server" OnClientClick="location.href='https://www.facebook.com/dialog/oauth?client_id=2277532892260615&response_type=code&scope=email&redirect_uri=https://localhost:44302/FB/facebookRedirect.aspx/';"  ><img src="../Images/fb_logo.jpg"/>Login with Facebook</asp:LinkButton><p class="lightText"><a href="signUpPage.aspx" class="homepageLink lightText">Don't have an account?</a></p>
